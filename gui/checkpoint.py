...
CHECKPOINT_PATH = BASE_DIR / "runtime" / "ejecucion_pendiente.json"
...
def crear_checkpoint(
    *,
    ...
    """Crea el estado inicial antes de abrir PSINet."""
...
def plan_pendiente(
    ...
    """Devuelve solo cámaras que nunca comenzaron a guardarse en PSINet."""
